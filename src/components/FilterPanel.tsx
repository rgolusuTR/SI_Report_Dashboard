...
import { FilterState, Website } from "../types";
import { REPORT_TYPES, DATE_RANGES } from "../constants";
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="mb-6 p-3 bg-gray-50 rounded-lg">
        <p className="text-sm text-gray-600">
          Showing{" "}
          <span className="font-semibold text-blue-600">{filteredRecords}</span>{" "}
          ...
          {websites.map((website: Website) => (
            ...
            >
              <input
                ...
                onChange={(e) =>
                  handleWebsiteChange(website.id, e.target.checked)
                }
